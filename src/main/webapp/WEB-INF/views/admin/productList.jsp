	...
	<div class="container">
		...
		<div class="table-responsive col-sm-10">
			...
			<tr>
				...
				<%
					com.QiBaochao.model.Product  p =(com.QiBaochao.model.Product) pageContext.findAttribute("p");
					int pid = p.getProductId();
					java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
					String catName = com.QiBaochao.model.Category.findByCategoryId(con,pid);
				%>
